function Automobile( year, make, model, type, expression ){
...
var automobiles = [ 
    new Automobile(1995, "Honda", "Accord", "Sedan", true),
...
logMe(sortArr(yearComparator, automobiles));
console.log('The cars sorted by make are:');
logMe(sortArr(makeComparator, automobiles));
console.log('The cars sorted by type are:');
logMe(sortArr(typeComparator, automobiles));
console.log('*****');
